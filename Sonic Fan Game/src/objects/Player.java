...
public class Player {
	...
	public void draw(Graphics2D graphics) {
		...
		if(DRAW_SPRITES) {
			...
			if(anim == SPINDASH_ANIM)        {spindashAnim.      draw(Loader.graphicsWidth / 2 - w / 2,          Loader.graphicsHeight / 2 - h / 2 - SPRITE_SCALE * SCALE / 2 - 14 * (SPRITE_SCALE * SCALE) -  3 * SPRITE_SCALE * SCALE, -facing, 1, Loader.graphicsWidth / 2, Loader.graphicsHeight / 2, getAngleOfVector(groundAxis), graphics);}
			if(anim == SPINDASH_CHARGE_ANIM) {spindashChargeAnim.draw(Loader.graphicsWidth / 2 - w / 2,          Loader.graphicsHeight / 2 - h / 2 - SPRITE_SCALE * SCALE / 2 - 14 * (SPRITE_SCALE * SCALE) -  3 * SPRITE_SCALE * SCALE, -facing, 1, Loader.graphicsWidth / 2, Loader.graphicsHeight / 2, getAngleOfVector(groundAxis), graphics);}
			...
			if(dustAnim == REGULAR_DUST_ANIM) {spindashDustAnim.      draw(Loader.graphicsWidth / 2 - w / 2, Loader.graphicsHeight / 2 - h / 2 - SPRITE_SCALE * SCALE / 2 - 14 * (SPRITE_SCALE * SCALE) -  3 * SPRITE_SCALE * SCALE, -facing, 1, Loader.graphicsWidth / 2, Loader.graphicsHeight / 2, getAngleOfVector(groundAxis), graphics);}
			if(dustAnim == CHARGE_DUST_ANIM)  {spindashChargeDustAnim.draw(Loader.graphicsWidth / 2 - w / 2, Loader.graphicsHeight / 2 - h / 2 - SPRITE_SCALE * SCALE / 2 - 14 * (SPRITE_SCALE * SCALE) -  3 * SPRITE_SCALE * SCALE, -facing, 1, Loader.graphicsWidth / 2, Loader.graphicsHeight / 2, getAngleOfVector(groundAxis), graphics);}
		}
	}
