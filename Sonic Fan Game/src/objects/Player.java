...
public class Player {
	...
	public void draw(float dt, Renderer r) {
		...
		if(DRAW_SPRITES) {
			...
			if(anim == RUN_ANIM) {
				     if(abs(groundSpeed) >= FASTEST_MIN_SPEED * SCALE) {runFastestAnim.draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
				else if(abs(groundSpeed) >= FAST_MIN_SPEED    * SCALE) {runFastAnim.   draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
				else if(abs(groundSpeed) >= NORMAL_MIN_SPEED  * SCALE) {runNormalAnim. draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
				else if(abs(groundSpeed) >= SLOW_MIN_SPEED    * SCALE) {runSlowAnim.   draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
				else                                                   {runSlowestAnim.draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			}
			
			if(anim == START_ANIM)           {startAnim.         draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == IDLE_ANIM)            {idleAnim.          draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == BOUNCING_UP_ANIM)     {bounceUpAnim.      draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == BOUNCING_DOWN_ANIM)   {bounceDownAnim.    draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == FALL_ANIM)            {fallAnim.          draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == SKID_ANIM)            {skidAnim.          draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == SKIRT_ANIM)           {skirtAnim.         draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == TURN_ANIM)            {turnAnim.          draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == CROUCH_ANIM_0)        {crouchAnim0.       draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == CROUCH_ANIM_1)        {crouchAnim1.       draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == JUMP_ANIM)            {jumpAnim.          draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == LAND_ANIM)            {landAnim.          draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == TRICK_RIGHT_ANIM)     {trickRightAnim.    draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == TRICK_UP_0_ANIM)      {trickUp0Anim.      draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == TRICK_UP_1_ANIM)      {trickUp1Anim.      draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == RAMP_ANIM)            {rampAnim.          draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == DASH_ANIM)            {dashAnim.          draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 + 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			
			if(anim == SWING_ANIM) {swingAnim.draw((pos.x - w / 2 - 32 + 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 - 2) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			
			if(anim == SPIN_ANIM) {spinAnim.draw((pos.x - w / 2) / 2 * Loader.scale, (pos.y - h / 2 - 32 - 4) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, 0, -facing * Loader.scale, Loader.scale, r);}
		
			if(anim == SPINDASH_ANIM)                   {spindashAnim.          draw((pos.x - w / 2 + s) / 2 * Loader.scale, (pos.y - h / 2 - 32 - 4) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(anim == SPINDASH_CHARGE_ANIM)            {spindashChargeAnim.    draw((pos.x - w / 2 + s) / 2 * Loader.scale, (pos.y - h / 2 - 32 - 4) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(dustAnim == REGULAR_DUST_ANIM && ground) {spindashDustAnim.      draw((pos.x - w / 2 + s) / 2 * Loader.scale, (pos.y - h / 2 - 32 - 4) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
			if(dustAnim == CHARGE_DUST_ANIM  && ground) {spindashChargeDustAnim.draw((pos.x - w / 2 + s) / 2 * Loader.scale, (pos.y - h / 2 - 32 - 4) / 2 * Loader.scale, pos.x / 2 * Loader.scale, pos.y / 2 * Loader.scale, t, -facing * Loader.scale, Loader.scale, r);}
		}
	}
