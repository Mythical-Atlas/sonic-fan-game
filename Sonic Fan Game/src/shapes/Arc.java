...
public class Arc extends Shape {
	...
	public void draw(Graphics2D graphics, Vector offset) {
		...
		graphics.fillArc((int)(points[1].x - getRadius() - offset.x), (int)(points[1].y - getRadius() - offset.y), (int)getRadius() * 2, (int)getRadius() * 2, (int)toDegrees(botAngle), (int)toDegrees(delAngle));
	}
}
